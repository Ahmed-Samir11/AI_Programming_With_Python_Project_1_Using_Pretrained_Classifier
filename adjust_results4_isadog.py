...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for key in results_dic:
      pet_name = results_dic[key][0].lower().strip()
      classified_named = results_dic[key][1].lower().strip()    
      if pet_name in dognames_dic and classified_named in dognames_dic:
        results_dic[key].extend([1,1])
      elif pet_name not in dognames_dic and classified_named in dognames_dic:
        results_dic[key].extend([0,1])
      elif pet_name in dognames_dic and classified_named not in dognames_dic:
        results_dic[key].extend([1,0])
      elif pet_name not in dognames_dic and classified_named not in dognames_dic:
